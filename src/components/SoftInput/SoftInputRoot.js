...
export default styled(InputBase)(({ theme, ownerState }) => {
  ...
  // padding values for focused state
  const focusedPaddingLeftValue = pxToRem(12);
  const focusedPaddingRightValue = pxToRem(12);

  // box shadow value for focused state
  ...
  const withIconStyles = () => {
    let withIconBorderRadiusValue = `${borderRadius.md} 0 0 ${borderRadius.md}`;
    let withIconPaddingLeftValue = pxToRem(12);
    let withIconPaddingRightValue = 0;
